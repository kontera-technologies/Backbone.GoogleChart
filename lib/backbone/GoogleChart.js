  ...
  Backbone.GoogleChart = (function(_super) {
    ...
    */
    ...
    GoogleChart.prototype.initialize = function(options) {
      (options.graphOptions != null) || (function() {
        throw "graphOptions key is missing";
      })();
      delete options.graphOptions.containerId;
      this.google = google.visualization;
      this.wrapper = new this.google.ChartWrapper(options.graphOptions);
      return ['ready', 'select', 'error'].map(this.listen);
    };
    ...
    */
    ...
    GoogleChart.prototype.listen = function(event) {
      ...
      return this.google.events.addListener(this.wrapper, event, function() {
        return _this.$el.trigger(event, _this.wrapper.getChart());
      });
    };
